...
To run the project locally, you need to set up a Python environment with the required dependencies. You can use `conda` to create an environment using the provided `environment.yml` file.
